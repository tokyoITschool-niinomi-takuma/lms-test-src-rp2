...
public class Case05 {
	...
	void test05() {
		...
		keyword.clear();
		keyword.sendKeys("研修");
		final WebElement search = webDriver.findElement(By.cssSelector("input.btn-primary[type='submit']"));
		search.click();
	...
	void test06() {
		// TODO ここに追加
		scrollTo("0");
		final WebElement clear = webDriver.findElement(By.cssSelector("input.btn-primary[type='button']"));
		clear.click();
		getEvidence(new Object() {
		});
	}
